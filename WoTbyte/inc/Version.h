...
{
  LOG_DEBUG("Version: {}.{}.{}", VERSION_MAJOR, VERSION_MINOR, VERSION_REVISION);
}

static inline void PrintBuildType()
{
  LOG_DEBUG("Build: {}", VER_VER_DEBUG ? "DEBUG" : "RELEASE");
}